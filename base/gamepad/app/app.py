...
class Gamepad:
    ...
    # =================================
    QUADCONT = {
        "ABS_Z": {"lb":0, "ub":255, "iv":0, "lbm":1000, "ubm":1350, "description":"throttle", "invert": False},
        "ABS_X": {"lb":-32768, "ub":32767, "iv":0, "lbm":1000, "ubm":2000, "description":"roll", "invert": False},
        "ABS_Y": {"lb":-32768, "ub":32767, "iv":0, "lbm":1000, "ubm":2000, "description":"pitch", "invert": True},
        "ABS_RX": {"lb":-32768, "ub":32767, "iv":0, "lbm":1000, "ubm":2000, "description":"yaw", "invert": False},

        "BTN_SOUTH": {"lb":0, "ub":1, "iv":0, "lbm":1100, "ubm":1800, "description":"aux1", "activated": False},
        "BTN_EAST": {"lb":0, "ub":1, "iv":0, "lbm":1100, "ubm":1800, "description":"aux2", "activated": False},
    }
    ...
    def start(self):
        ...
        while True:
            ...
            for event in events:
                ...
                if event.code in ["BTN_SOUTH", "BTN_EAST"]:
